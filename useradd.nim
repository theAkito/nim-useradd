...
proc addUser*(name: string, uid: int, gid = uid, home: string, shell = "", pw = "", pwIsEncrypted = false, gecos = ""): bool =
  ...
  var
    realGid = gid.Gid
    passwd = when not cpuARM: ## https://github.com/nim-lang/Nim/blob/f5d70e7fa7195658e3200f71a1653e07fe81275a/lib/posix/posix.nim#L103-L114
    ...
    grp = when not cpuARM: ## https://github.com/nim-lang/Nim/blob/f5d70e7fa7195658e3200f71a1653e07fe81275a/lib/posix/posix.nim#L103-L114
        Group(
          gr_name: name,
